...
def solution(word, pages):
    ...
    for i, page in enumerate(pages):
        pagetitle=page.split('<meta property="og:url" content="https://')[1].split('"')[0]
        links=[]
        for link_long in page.split('a href="https://')[1:]:
            links.append(link_long.split('"')[0])
        webpages[pagetitle]=[i,getScore(word,page),links,0]
